...
namespace CarPark
{
    class Program
    {
        ...
        static string connectionString = "Server=.;Initial Catalog=CarPark;Integrated Security=true; Encrypt=True;Trust Server Certificate=True";
        ...
        {
            string query = @"UPDATE ParkingForCarParkApp 
        ...
        {
            string query = @"INSERT INTO ParkingForCarParkApp (FirstName, 
                                                  LastName, 
                                                  SocialSecurityNumber,
                                                  PhoneNumber,
                                                  Email,
